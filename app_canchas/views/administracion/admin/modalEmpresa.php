...
$id = $_GET['id'];
if ($id === 'crear') {
    $mensaje = "Crear Empresa";
    $empresa = $empresas;
} else {
    $mensaje = "Actualizar Empresa";
    $empresa = $empresas->getEmpresa($id);
}
?>
<form id="crearModificarEmpresa" name="crearModificarEmpresa" method="post" action="/Controllers/empresaController.php"
